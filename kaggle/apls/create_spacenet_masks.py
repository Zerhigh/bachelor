...
def create_masks(path_data, buffer_meters=2, n_bands=3,
    ...
    t0 = time.time()
    # set paths
    path_labels = os.path.join(path_data) #, 'geojson_roads/spacenetroads'
    # output directories
    ...
    if n_bands == 3:
        ...
        path_images_8bit = os.path.join(path_data, 'PS-RGB_8bit')
    else:
...
def main():
    ...
    parser.add_argument('--path_data', default='C:/Users/shollend/bachelor/test_data/', type=str,
                        help='Folder containing imagery and geojson labels')
    parser.add_argument('--output_df_path', default='C:/Users/shollend/bachelor/test_data/', type=str,
